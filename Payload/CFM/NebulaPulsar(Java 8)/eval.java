    ...
    public boolean equals(Object objParam)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                String scriptSourceCode = new String(decodedBytes, "UTF-8").trim();
                ...
                Object evalResult = engine.eval(scriptSourceCode);
                String executionResult = evalResult != null ? evalResult.toString() : "";
            ...
            {
                sb.append("Error during script eval: " + ex.toString());
            }
